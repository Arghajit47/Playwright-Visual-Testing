...
test.describe("Take screenshots for Visual Regression Testing - The Internat webpage", () => {
  /** @type {HelperFunction} */
  ...
  test(
    "The Internet webpage - Desktop - Setup Baseline",
    { tag: "@setupProject" },
    async ({ page }) => {
  ...
  test(
    "The Internet webpage - Desktop - Validate Mismatch",
    { tag: "@validation" },
    async ({ page }, testInfo) => {
      await allure.severity("minor");
