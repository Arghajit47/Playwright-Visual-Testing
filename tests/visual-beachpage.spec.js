...
test.describe("Take screenshots for Visual Regression Testing - Beach page", () => {
  ...
  test(
    "Beach page - Desktop - Setup Baseline",
    { tag: "@setupProject" },
    async ({ page }) => {
      await allure.severity("minor");
      const currentScreenshot = `${currentDir}/desktop/Beach-page-current.png`;
      const baselineScreenshot = `${baselineDir}/desktop/Beach-page-baseline.png`;
      ...
      await uploadImage(`desktop/Beach-page-baseline.png`, baselineScreenshot);
  ...
  test(
    ...
    async ({ page }) => {
      ...
      const currentScreenshot = `${currentDir}/desktop/Beach-page-current.png`;
      const baselineScreenshot = `${baselineDir}/desktop/Beach-page-baseline.png`;
      const diffScreenshot = `${diffDir}/desktop/Beach-page-diff.png`;
  ...
  test(
    "Beach page - Mobile - Setup Baseline",
    { tag: "@setupProject" },
    async ({ page }) => {
      await allure.severity("minor");
      const currentScreenshot = `${currentDir}/mobile/Beach-page-current.png`;
      const baselineScreenshot = `${baselineDir}/mobile/Beach-page-baseline.png`;
      ...
      console.log(`Creating baseline for ${test.info().title} test...`);
      fs.copyFileSync(currentScreenshot, baselineScreenshot);
      await uploadImage(`mobile/Beach-page-baseline.png`, baselineScreenshot);
      console.log("Baseline created. Run the test again for comparisons.");
    }
  );

  test(
    "Beach page - Mobile - Validate Mismatch",
    { tag: "@validation" },
    async ({ page }) => {
      await allure.severity("minor");
      const currentScreenshot = `${currentDir}/mobile/Beach-page-current.png`;
      const baselineScreenshot = `${baselineDir}/mobile/Beach-page-baseline.png`;
      const diffScreenshot = `${diffDir}/mobile/Beach-page-diff.png`;
