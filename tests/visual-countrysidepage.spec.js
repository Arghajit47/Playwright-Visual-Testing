...
test.describe("Take screenshots for Visual Regression Testing - Countryside page", () => {
  ...
  test(
    "Countryside page - Desktop - Setup Baseline",
    { tag: "@setupProject" },
    async ({ page }) => {
  ...
  test(
    ...
    async ({ page }) => {
      ...
      const currentScreenshot = `${currentDir}/desktop/Countryside-page-current.png`;
      const baselineScreenshot = `${baselineDir}/desktop/Countryside-page-baseline.png`;
      const diffScreenshot = `${diffDir}/desktop/Countryside-page-diff.png`;
  ...
  test(
    "Countryside page - Mobile - Setup Baseline",
    { tag: "@setupProject" },
    async ({ page }) => {
      await allure.severity("minor");
      const currentScreenshot = `${currentDir}/mobile/Countryside-page-current.png`;
      const baselineScreenshot = `${baselineDir}/mobile/Countryside-page-baseline.png`;
      ...
      fs.copyFileSync(currentScreenshot, baselineScreenshot);
      await uploadImage(
        `mobile/Countryside-page-baseline.png`,
        baselineScreenshot
      );
      console.log("Baseline created. Run the test again for comparisons.");
    }
  ...
  test(
    "Countryside page - Mobile - Validate Mismatch",
    { tag: "@validation" },
    async ({ page }) => {
      await allure.severity("minor");
      const currentScreenshot = `${currentDir}/mobile/Countryside-page-current.png`;
      const baselineScreenshot = `${baselineDir}/mobile/Countryside-page-baseline.png`;
      const diffScreenshot = `${diffDir}/mobile/Countryside-page-diff.png`;
